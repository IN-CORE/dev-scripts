package edu.illinois.ncsa.tools.common.util.bean;

import edu.illinois.ncsa.tools.common.AbstractSerializationComparator;
import edu.illinois.ncsa.tools.common.comparators.DefaultSerializationComparator;
import edu.illinois.ncsa.tools.common.exceptions.ReflectionException;
import edu.illinois.ncsa.tools.common.exceptions.SerializationException;
import edu.illinois.ncsa.tools.common.util.ReflectUtils;
import edu.illinois.ncsa.tools.common.util.StringUtils;
import edu.illinois.ncsa.tools.common.util.TypeUtils;
...
{
	static Namespace namespace = new Namespace("meta", "ncsa.edu.illinois.ncsa.tools.common.util");
