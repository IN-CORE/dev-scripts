package edu.illinois.ncsa.tools.common.util;

import edu.illinois.ncsa.tools.common.NCSAConstants;
import edu.illinois.ncsa.tools.common.exceptions.FileReadException;
import edu.illinois.ncsa.tools.common.exceptions.FileWriteException;
import edu.illinois.ncsa.tools.common.exceptions.VerificationException;
import edu.illinois.ncsa.tools.common.types.FileFormatType;
import edu.illinois.ncsa.tools.common.types.filters.RegExFilter;
import edu.illinois.ncsa.tools.common.types.filters.RegExFilterQueue;
...
public class FileUtils
{
	...
	public static void writeBinary(File file, List content, boolean append, String mode) throws FileWriteException
	{
		...
		try {
			...
			throw new FileWriteException("edu.illinois.ncsa.FileUtils.write, could not call seek on " + raf, ioe);
		}
		...
		try {
			...
			throw new FileWriteException("edu.illinois.ncsa.FileUtils.write", ioe);
		} finally {
			try {
				raf.getFD().sync();
				raf.close();
