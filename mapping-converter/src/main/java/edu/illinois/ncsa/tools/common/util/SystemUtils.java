...
import edu.illinois.ncsa.tools.common.concurrent.ExceptionPreservingThread;
import edu.illinois.ncsa.tools.common.data.UnixProcessReader;
import edu.illinois.ncsa.tools.common.types.Profile;
import edu.illinois.ncsa.tools.common.types.Property;
...
public class SystemUtils
{
	 ...
	 * @return list of environment legacyMappings, i.e., name=value.
	 * @see #processEnv
	 */
	 ...
	 * 
	 * @param properties
	 *            ncsa.edu.illinois.ncsa.tools.common.types.Property list to check (in order).
