...
geoserver_url = ''  # url for utils rest service http://localhost/geoserver/rest/'
geoserver_user = '' # utils user name
geoserver_pwd = ''  # utils password
...
class Geoserver:
        ...
        for file in dirlist:
            ...
            if extension.lower() == extension_asc:
                ...
                try:
                    ...
                    print("Raster " + dataset_id + " uploaded to utils")
                except:
                    print(
                        "There was an error uploading a raster " + dataset_id + ". Possibly the data already exist in the utils")
                    pass
    ...
    def upload_shpfile_to_geoserver(dataset_id: str, localfile: str, workspace_name: str):
        ...
        print("Shapefile " + dataset_id + " uploaded to utils")
        # except:
        print(
            "There was an error uploading a shapefile " + dataset_id + ". Possibly the data already exist in the utils")
        # pass
    ...
    def upload_shp_dataset_geoserver(dataset_id: str, workspace_name: str):
        ...
        if (metadata.get('format').lower() == format_shp):
            ...
            try:
                ...
                print("Dataset uploaded to utils")
            except:
                print("There was an error uploading a dataset. Possibly the data already exist in the utils")
                pass
